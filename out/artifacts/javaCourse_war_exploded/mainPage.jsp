                ...
                success:function (obj) {
                    ...
                    for(var i=0;i<ListLength;i++){
                        ...
                        notice[i].onclick = function(){ 
                            layer.alert('‘' + obj.data1[this.index].movieCnName + '’电影暂未有预告片！',{icon: 0,offset: clientHeight/7});
                        }
                        sale[i].index = i;
                        sale[i].onclick = function(){
                            layer.alert('预售‘' + obj.data1[this.index].movieCnName + '’电影成功！',{icon: 0,offset: clientHeight/7});
                        }
                    }
                    initBoxOffice(obj);
                }
        ...
        function initBoxOffice(obj){
            ...
            for(var i=0;i<TempLength;i++){
                if(i==0){
                    BoxOffice.append(
                        "<li class=\"ranking-item ranking-top ranking-index-1\">" +
                            "<a href=" + obj.sort[i].movieId + "\"movieDetail.jsp?movie_id=\" target=\"_blank\">" +
                                "<div class=\"ranking-top-left\">" +
                                    "<i class=\"ranking-top-icon\"></i>" +
                                    "<img class=\"ranking-imgs  default-img\" src=\"" + obj.sort[i].moviePicture + "\">" +
                                "</div>" +
                                "<div class=\"ranking-top-right\">" +
                                    "<div class=\"ranking-top-right-main\">" +
                                        "<span class=\"ranking-top-moive-name\">" + obj.sort[i].movieCnName + "</span>" +
                                        "<p class=\"ranking-top-wish\">" +
                                            "<span class=\"stonefont\">" + obj.sort[i].movieBoxOffice + "</span>万" +
                                        "</p>" +
                                    "</div>" +
                                "</div>" +
                            "</a>" +
                        ...
                        "<li class=\"ranking-item ranking-index-4\">" +
                            "<a href=" + obj.sort[i].movieId + "\"movieDetail.jsp?movie_id=\" target=\"_blank\">" +
                                "<span class=\"normal-link\">" +
                                    ...
                                    "<span class=\"ranking-movie-name\">" + obj.sort[i].movieCnName + "</span>" +
                                    "<span class=\"ranking-num-info\">" +
                                        "<span class=\"stonefont\">" + obj.sort[i].movieBoxOffice + "</span>万" +
                                    "</span>" +
                                "</span>" +
