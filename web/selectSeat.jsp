    ...
    <script>
        ...
        function initMoive(obj){
           // console.log(obj);
            ...
            for(var i=0;i<5;i++){
                movieList.append(
                    "<div class=\"movie active\" data-index=\"0\">" +
                        "<img src=\"static/images/stills/" + obj.data[0].scheduleMovie.movieCnName + "/" + (i+1) + ".jpg\" alt=\"\">" +
                    "</div>"
                );
            }
            ...
            movieInfo.append(
                "<div>" +
                    "<h3 class=\"movie-name\">"+ obj.data[0].scheduleMovie.movieCnName +"</h3>" +
                    "<span class=\"score sc\">"+ obj.data[0].scheduleMovie.movieScore +"</span>" +
                "</div>" +
                "<div class=\"movie-desc\">" +
                    "<div>" +
                        "<span class=\"key\">时长 : </span>" +
                        "<span class=\"value\">"+ obj.data[0].scheduleMovie.movieDuration +"</span>" +
                    "</div>" +
                    "<div>" +
                        "<span class=\"key\">类型 :</span>" +
                        "<span class=\"value\">"+ obj.data[0].scheduleMovie.movieType +"</span>" +
                    "</div>" +
                    "<div>" +
                        "<span class=\"key\">导演 :</span>" +
                        "<span class=\"value\">"+ obj.data[0].scheduleMovie.movieDirector+"</span>" +
                    "</div>" +
                "</div>"
            )
