                      ...
                      //  var order_time = obj.data[i].order_schedule.schedule_startTime.slice(0,10);
                        ...
                        "<div class=\"order-box\">" +
                            "<div class=\"order-head\">" +
                                    "<span class=\"order-date\">" + obj.data[i].orderTime + "</span>" +
                                    "<span class=\"order-id\">订单号：" + obj.data[i].orderId + "</span>" +
                                    "<span class=\"order-delete\">*</span>" +
                                    "</div>" +
                            "<div class=\"order-body\">" +
                                "<div class=\"poster\"><img src=\"" + obj.data[i].orderSchedule.scheduleMovie.moviePicture + "\"></div>" +
                                "<div class=\"order-content\">" +
                                    "<div class=\"movie-name\">" + obj.data[i].orderSchedule.scheduleMovie.movieCnName + "</div>" +
                                    " <div class=\"cinema-name\">" + obj.data[i].orderSchedule.scheduleHall.hallCinema.cinemaName + "</div>" +
                                    "<div class=\"hall-ticket\">"  + obj.data[i].orderSchedule.scheduleHall.hallName + " " + obj.data[i].orderPosition + "</div>" +
                                    "<div class=\"show-time\">" + obj.data[i].orderSchedule.scheduleStartTime + "</div>" +
                                "</div>" +
                                "<div class=\"order-price\">￥" + obj.data[i].orderSchedule.schedulePrice + "</div>" +
                                "<div class=\"order-status\">" + StateText + "</div>" +
                                "<div class=\"actions\"><a onclick=\"backticket('" + obj.data[i].orderId + "','" + obj.data[i].orderSchedule.scheduleStartTime  + "','" + StateText + "')\" style=\"cursor: pointer;\">申请退票</a></div>" +
                            "</div>" +
                        "</div>";
                        order.append(html);
                    }
