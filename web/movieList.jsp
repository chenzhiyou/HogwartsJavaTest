            ...
            $.ajax({
                ...
                success: function(obj){
                    ...
                    for(var i = 0;i < obj.count; i++){
                        movielist.append(
                            "<li> <div class=\"movie-item\"> <a href=\"./buyTickets.jsp?movie_id="+ obj.data[i].movieId +"\" target=\"_blank\"> <div class=\"movie-poster\"> <img src=\""+ obj.data[i].moviePicture +"\"> </div> </a>" +
                            "<div class=\"channel-action channel-action-sale\"> <a>购票<a/> </div> <div class=\"movie-ver\"></div> </div>" +
                            "<div class=\"channel-detail movie-item-title\" title=\""+ obj.data[i].movieCnName +"\">" +
                            "<a href=\"./movieDetail.jsp?movie_id="+ obj.data[i].movieId +"\" target=\"_blank\">"+ obj.data[i].movieCnName +"</a> </div>" +
